  ...
  if (!GOOGLE_MAPS_API_KEY || GOOGLE_MAPS_API_KEY === "YOUR_API_KEY_HERE") {
    return (
      <Card className="p-8 bg-yellow-50 border-yellow-200">
        ...
        <p className="text-yellow-700 mb-4">Please add your Google Maps API key to CompetitorMap.tsx (line 29)</p>
        <ol className="text-sm text-yellow-700 space-y-1 list-decimal list-inside">
          <li>Open CompetitorMap.tsx in Lovable</li>
          <li>
            Find line 29: <code className="bg-yellow-100 px-1">const GOOGLE_MAPS_API_KEY = "YOUR_API_KEY_HERE"</code>
          </li>
